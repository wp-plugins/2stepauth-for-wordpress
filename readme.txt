...
2StepAuth increases security of Wordpress blogs by adding 2nd level of Authentication. Secures your blog from hackers.
...
Features:
- Adds 2nd level of Authentication.
- Prevents hacker from accessing Admin Panel even in case of leaked password.
- Prevents hacker from changing WordPress password.
- Supports multiple Administrators.
- Can remember verified user for 15 days.

2nd level of Authentication is implemented using:

    * SMS Code Verification:
      SMS containing a verification code is sent to your verified mobile phone. Simply enter this verification code correctly to access your WordPress.
    * Backup Codes:
      Backup Codes are generated by this plugin and you have to save these Backup codes at a safe location. During verification, enter one of these Backup Codes to access your WordPress. Note that each Backup code can be used just once.
    * Email Code Verification:
      SMS Code Verification may be disabled or may not be supported. Hence, we have provided Email Authentication feature. You have to correctly enter the Verification code sent to your email inorder to access your blog.
...
= 1.1 =
Updated the plugin information.